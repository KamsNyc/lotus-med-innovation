...
const Navbar = () => {
  return (
    <div className="">
      {/* CONTAUNER */}
      <nav className="fixed flex h-16 mt-2 w-full items-center justify-between px-4 sm:px-8 md:px-16 lg:px-40 z-20">
         {/* Logo */}
    ...
    {/* NAVLINK */}
        <ul className="flex items-center justify-end gap-4 sm:gap-8 lg:gap-8 flex-grow text-[16px] tracking-widest text-[#eeeeee] font-light pl-[50px]">
